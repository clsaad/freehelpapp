...
if ($table == "service")
{
    $filename = "FreeHelp - Serviços.tsv";
    ...
    $array = array(
        ...
        "(SELECT name FROM category WHERE id=service.category3) as 'Categoria 3'",
...
{
    $filename = "FreeHelp - Ocupações.tsv";
...
$empty = isset($_GET["emptytable"]) ? TRUE : FALSE;
$download_me = TSV::QueryAsTSV($query, $empty); 
